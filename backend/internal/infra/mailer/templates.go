...
func ParseDailyDigestTemplates() (*htmltemplate.Template, *htmltemplate.Template, error) {
	...
	textTmpl, err := htmltemplate.ParseFS(templatesFS, "templates/daily_digest.txt")
	if err != nil {
